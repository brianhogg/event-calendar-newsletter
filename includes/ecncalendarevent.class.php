...
if ( ! class_exists( 'ECNCalendarEvent' ) ) {
    class ECNCalendarEvent {
         ...
         */
        public function replace_conditional_tag( $tag, $condition, $output ) {
        ...
        public function replace_start_date_with_format( $matches ) {
            return date_i18n( $matches[1], $this->get_start_date() );
        }

        public function replace_end_date_with_format( $matches ) {
